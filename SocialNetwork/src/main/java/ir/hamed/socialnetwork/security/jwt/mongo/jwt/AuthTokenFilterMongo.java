...
public class AuthTokenFilterMongo extends OncePerRequestFilter {
    ...
    @Autowired(required = false)
    private UserMongoDetailsServiceImpl userDetailsService;

    private static final Logger logger = LoggerFactory.getLogger(AuthTokenFilterMongo.class);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtilsMongo.validateJwtToken(jwt)) {
                String username = jwtUtilsMongo.getUserNameFromJwtToken(jwt);
