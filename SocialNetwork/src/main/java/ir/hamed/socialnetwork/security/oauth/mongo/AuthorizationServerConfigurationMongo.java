...
public class AuthorizationServerConfigurationMongo extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private CustomUserDetailsServiceMongo userDetailsService;
